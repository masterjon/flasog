...
//  flasog
//
//  Created by Jonathan Horta on 7/24/17.
//  Copyright © 2017 iddeas. All rights reserved.
//

import UIKit
import Segmentio
class CancunVC: UIViewController {
    ...
    private func segmentioContent() -> [SegmentioItem] {
        ...
        return [
            SegmentioItem(title: "Cancun", image: UIImage(named: "CancunAzul")),
            SegmentioItem(title: "Hoteles", image: UIImage(named: "HotelesAzul")),
            SegmentioItem(title: "Lugares", image: UIImage(named: "LugaresAzul"))
    ...
    private func preparedViewControllers() -> [UIViewController] {
        ...
        let tab1 = StaticTabViewController.create(storyboardId:"cancun1")
        
        let tab2 = HotelesVC.create(storyboardId:"cancun2")
        
        let tab3 = LugaresVC.create(storyboardId:"cancun3")
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        tracker?.set(kGAIScreenName, value: "Cancún")
...
extension CancunVC : UIScrollViewDelegate{
