...
class EventosVC: UIViewController {
    ...
    private func segmentioContent() -> [SegmentioItem] {
        ...
        return [
            SegmentioItem(title: "FLASOG 2017", image: nil),
            SegmentioItem(title: "Pdte. FLASOG", image: nil ),
            SegmentioItem(title: "Pdte. FEMECOG", image: nil ),
            SegmentioItem(title: "Pdte. CONGRESO", image: nil ),
    ...
    private func preparedViewControllers() -> [StaticTabViewController] {
        ...
        let tab1 = StaticTabViewController.create(storyboardId:"vc3")
        
        let tab2 = StaticTabViewController.create(storyboardId:"vc4")
        
        let tab3 = StaticTabViewController.create(storyboardId:"vc5")
        
        let tab4 = StaticTabViewController.create(storyboardId:"vc6")
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        tracker?.set(kGAIScreenName, value: "Evento")
...
extension EventosVC : UIScrollViewDelegate{
