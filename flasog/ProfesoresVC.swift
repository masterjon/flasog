...
class ProfesoresVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    let profesores = [
        ...
        ["nombre":"Dr. Antonio Santillán",
         "especialidad":"Ginecólogo oncólogo certificado en cirugíarobótica",
         "pais":"USA",
         "imagen":"AntonioSantillan",
         "descripcion":"- Trabaja actualmente en TexasOncology,San Antonio Medical Center y en elTexasOncology, San Antonio Stone Oak, EUA\n\n- Sus áreas de experiencia son:cirugía de mínimainvasión y cirugíarobótica"],
